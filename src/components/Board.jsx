...
const Board = () => {
    ...
    const setWinner = () => {
        if (user === 'rock' && computer === 'scissors') {
            setUserCounter(prevUserCounter => prevUserCounter + 1);
        }
        if (user === 'rock' && computer === 'paper') {
            setComputerCounter(prevComputerCounter => prevComputerCounter + 1);
        }
        ...
        if (userCounter + computerCounter >= 3) {
            userCounter > computerCounter ? setResult('YOU WIN') : setResult('YOU LOSE')
        } else {
            setTimeout(() => {
                setUser('')
                setComputer('')
    ...
    console.log(userCounter, computerCounter, user, computer)
        ...
        <>
            {user === '' ?
                <div className="board">
                    ...
                    <svg className='triangle' width="313" height="278" xmlns="http://www.w3.org/2000/svg"><path stroke="#000" stroke-width="15" fill="none" opacity=".2" d="M156.5 262 300 8H13z" /></svg>
                </div>
                :
